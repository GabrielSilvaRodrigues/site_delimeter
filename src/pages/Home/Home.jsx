  ...
  return (
    <main className="home-main">
      ...
      <section className="container-main">
        ...
        <div className="caixas">
          <div className="caixaAlfa caixaRelativa">
            ...
            <a href="/delimeter/sobre" className="link">Saiba mais</a>
          </div>
          <div className="caixaAlfa caixaRelativa">
            <h2>Dados métricos</h2>
            <p>Calcule o seu gasto energético basal</p>
            <a href="/delimeter/calculo" className="link">Saiba mais</a>
          </div>
        </div>
      ...
      <section className="funcionalidades">
        ...
        <div className="caixas">
          <div className="caixa">
            <a href="#"><img src="/public/assets/images/nutricionista.jpg" alt="Nutricionista" className="caixaRelativa" /></a>
            <h3>Marque uma consulta com uma nutricionista</h3>
            <p>Para acompanhar sua alimentação.</p>
          </div>
          <div className="caixa">
            <a href="#"><img src="/public/assets/images/dieta.jpg" alt="Dieta" className="caixaRelativa" /></a>
            <h3>Dietas focadas no seu perfil</h3>
            <p>Através do mapeamento de dados.</p>
          </div>
          <div className="caixa">
            <a href="#"><img src="/public/assets/images/crianca.jpg" alt="Criança" className="caixaRelativa" /></a>
