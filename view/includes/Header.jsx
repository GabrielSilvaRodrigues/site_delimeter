        ...
        <div className="overlay">
          <nav>
            <ul aria-label="Acessibilidade" className="acessibilidade">
              ...
              <li>
                <button
                  onClick={() => window.aumentarFonte()}
                  id="aumentar-fonte-btn"
              ...
              <li>
                <button
                  onClick={() => window.diminuirFonte()}
                  id="diminuir-fonte-btn"
              ...
              <li>
                <button
                  onClick={() => window.toggleContraste()}
                  id="contraste-btn"
                  aria-pressed="false"
              ...
              <li>
                <button
                  onClick={() => window.toggleDaltonismo('protanopia')}
              ...
              <li>
                <button
                  onClick={() => window.toggleDaltonismo('deuteranopia')}
              ...
              <li>
                <button
                  onClick={() => window.toggleDaltonismo('tritanopia')}
              ...
              <li>
                <button
                  onClick={() => window.resetarAcessibilidade()}
